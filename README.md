  ...
  match /databases/{database}/documents {
    ...
    <script>
        ...
        function loadSampleConfig() {
            ...
            document.getElementById('apiKey').value = 'AIzaSyC_sample_key_123456789';
            document.getElementById('authDomain').value = 'your-project.firebaseapp.com';
            document.getElementById('projectId').value = 'your-project-id';
            document.getElementById('storageBucket').value = 'your-project.appspot.com';
        ...
        function initializeFirebase() {
            ...
            try {
                ...
                updateFirebaseStatus('disconnected', '❌ Failed to connect: ' + error.message);
        ...
        function updateSummary() {
            ...
            if (balance < 0) {
                ...
                recommendationsDiv.innerHTML = `
                    <div class="warning">⚠️ Payment overdue: $${amountDue.toFixed(2)}</div>
